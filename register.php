  ...
  ?>
              ...
              <form class="user" action="register.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group"> 
                  <input type="email" class="form-control form-control-user" id="paymentemail" name="paymentemail" placeholder="Payment Email Address">
                </div>
                <div class="form-group">
                ...
                <input type="password" class="form-control form-control-user" id="password" name="password" placeholder="Password">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control form-control-user" id="referrer" name="referrer" placeholder="Referrer (if any)">
                  </div>
